...
The documentation is a work in progress, check it out here:

http://chrismoos.com/fastr

You can help with the documentation by forking this repository: 

http://github.com/chrismoos/fastr_docs
